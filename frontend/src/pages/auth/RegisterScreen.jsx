...
const RegisterScreen = () => {
  ...
  // Pull the register function from your persistent Zustand store
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Await the persistent store's register function
      await registerUser(
        formData.first_name,
        formData.last_name,
        generatedUsername,
      ...
      // Strictly route to OTP, preventing profile screen overlap
      navigate('/auth/verify-email', { replace: true })
      
    } catch (error) {
      console.error('Registration error:', error)
      // Grab the error message generated by your authStore
